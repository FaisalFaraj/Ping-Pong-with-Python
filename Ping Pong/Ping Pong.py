import turtle
#create screen for game with detailes
wind = turtle.Screen()
wind.title('Ping Pong By Faisal')
wind.bgcolor('black')
...
while True:
    ...
    #make border for madrab1, madrab2 size of madrab1,2 is 100px for half screen be 50px
    if madrab1.ycor() > 250 :
        madrab1.sety(250)
    ...
    #move the ball
    ball.setx(ball.xcor() + ball.dx) #ball starts at 0 and eveytime loops run--->2.5 xaxis
    ball.sety(ball.ycor() + ball.dy) #ball starts at 0 and eveytime loops run--->2.5 yaxis
